...
| 6 | <code><a name="Evidence_Type">Evidence_Type</a></code> | <code>[ID](#ID)</code>| `ECO:0000315` | The evidence identifier MUST be a term from the ECO ontology. Mapping file in progress: [https://github.com/evidenceontology/evidenceontology#249](https://github.com/evidenceontology/evidenceontology/issues/249) |
